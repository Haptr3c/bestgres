...
// PatroniSpec defines the Patroni-specific configuration
type PatroniSpec struct {
	// +kubebuilder:validation:Required
	Image string `json:"image"`
	// +kubebuilder:default="/home/postgres"
	WorkingDir string `json:"workingDir,omitempty"`
	// +kubebuilder:default={"/bin/sh","/entrypoint.sh"}
...
func (in *BGClusterSpec) DeepCopyInto(out *BGClusterSpec) {
	*out = *in
	out.Patroni = in.Patroni.DeepCopy()
}
...
// DeepCopy is a deepcopy function for PatroniSpec
